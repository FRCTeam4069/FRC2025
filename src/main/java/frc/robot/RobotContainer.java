...
import frc.robot.commands.autos.RedMiddleBallFix;
import frc.robot.commands.autos.RedMiddleBallFix;
...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        autoChooser.addOption("red middle ball fix", new RedMiddleBallFix(drive, elevator, arm, manipulator, commands));

...
// public class AlgaeAutomationCommand extends SequentialCommandGroup {
//   /** Creates a new BlueRightTwoCoral. */

//   public AlgaeAutomationCommand(SwerveDrivetrain drive, Elevator elevator, Arm arm, Manipulator manipulator, RobotCommands commands) {

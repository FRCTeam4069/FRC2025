...
public class RedRightTwoCoral extends SequentialCommandGroup {
  /** Creates a new BlueRightTwoCoral. */
  public RedRightTwoCoral(SwerveDrivetrain drive, Elevator elevator, Arm arm, Manipulator manipulator, RobotCommands commands) {
